...
class HelpersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create helper" do
    assert_difference("Helper.count") do
      post helpers_url, params: { helper: { occupation: @helper.occupation, summary: @helper.summary, user_id: @helper.user_id } }
    end
  ...
  test "should update helper" do
    patch helper_url(@helper), params: { helper: { occupation: @helper.occupation, summary: @helper.summary, user_id: @helper.user_id } }
